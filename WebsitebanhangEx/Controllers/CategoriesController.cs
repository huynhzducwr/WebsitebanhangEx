...
namespace WebsitebanhangEx.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create(Category cate)
        {
            ...
            {
                // Ghi log ngoại lệ hoặc hiển thị chi tiết để kiểm tra lỗi
                Console.WriteLine($"Lỗi khi tạo mới danh mục: {ex.Message}");
                return Content($"Lỗi khi tạo mới danh mục: {ex.Message}");
            }
        }
